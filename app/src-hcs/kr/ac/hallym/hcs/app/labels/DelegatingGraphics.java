...
/** 모든 그리기를 감싼 Graphics2D에 그대로 넘기는 바탕 클래스(#79). 거르는 쪽이 필요한 메서드만 바꾼다. */
class DelegatingGraphics extends Graphics2D {
    protected final Graphics2D g;

    DelegatingGraphics(Graphics2D g) {
        this.g = g;
    }
    ...
    public Graphics create() {
        return new DelegatingGraphics((Graphics2D) g.create());
    }
