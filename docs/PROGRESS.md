...
| ID | 제목 | 이슈 | 상태 | PR | 스크린샷·근거 |
| --- | --- | --- | --- | --- | --- |
| C-01 | 기록 엔진 | #199 | 완료 | (이 PR) | D-073, RecordingTest(실제 값·재실행·입력 바꿈·뒤 버리기·상한·체크포인트 줄이기), RecorderTest(원조 Simulator 틱·리셋·편집), RecordingPerformanceTest, PERFORMANCE.md |
| C-02 | 사이클 표 | #200 | 대기 |  |  |
