...
| C-02 | 사이클 표 | #200 | 완료 | (이 PR) | D-074, CycleModelTest(PC·.s 원래 줄·디스어셈블·줄 값), MipsTextTest(tests/asm 원래 줄·분기 라벨), CycleViewGuiTest, 25a·25b |
| C-03 | 열 클릭과 뒤로 가기 | #201 | 완료 | (이 PR) | D-074, RecorderViewTest(지난 스텝 보기·지금으로 돌아오기·서브회로 안 시점·지난 스텝에서 진행·입력 바꿈·ref-mips factorial), CycleViewGuiTest(열 누르기·상태 표시줄·Next Cycle), 25c·25d |
