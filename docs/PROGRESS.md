...
| S-10 | 화면 맞춤 여백 | #173 | 완료 | #252, 후속(이 PR) | D-068, ZoomMathTest.fitPlacementCentersBothAxes·originCapIsTheCenteringAmount, FitCenterGuiTest(가운데·누른 자리·원조 배율 조절·커서 배율·원점 한도), 02, 18o |
