...
| ID | 제목 | 이슈 | 상태 | PR | 스크린샷·근거 |
| --- | --- | --- | --- | --- | --- |
| X-01 | 첫 실행 창 크기, 포크 전용 창 설정 | #305 | 완료 | #310 | 48-first-run(x01) |
| X-02 | 도구 모음 넘침(Icons Only 자동 → » 메뉴) | #306 | 완료 | #311 | 49-toolbar-*(x02) |
| X-03 | 좁은 창의 패널 비율(캔버스 최소 폭) | #307 | 완료 | #312 | 50-panels-*(x03) |
| X-04 | Registers PC 줄 이름·안내 조건·칩과 강조 선 간격 | #308 | 완료 | #313 | 25b·30b(x04) |
| X-05 | windows-smoke 보강·Xvfb 첫 실행 장면·v1.0.2 릴리스 | #309 | 완료 | #314, #315, #316, #317 | review-shots 2026-09-27-v102 (최종 세트 230장, windows-smoke 4장), 릴리스 v1.0.2 |
