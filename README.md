...
로드맵 0~4단계(PLAN.md 9장)와 편집기 개선(11장)을 마쳤다. v1.0.0부터 공개 릴리스이고, v1.0.1은 첫 검토에서 나온 문제(새 파일의 Hallym MIPS, 진단 문구, 사이클 표 임시 줄, 활성 경로, 탭 이름, Signal Flow 호, 빈 캔버스 안내, PC 판별)를 고친 패치다.
